window.GOVUKPrototypeKit = window.GOVUKPrototypeKit || {}
window.GOVUKPrototypeKit.Modules = window.GOVUKPrototypeKit.Modules || {}; // if this ; is omitted, none of this JS runs :(
...
})(window.GOVUKPrototypeKit.Modules)
